...
CREATE TABLE `accesorio` (
  ...
  `nombre_accesorio` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `id_lote` int DEFAULT NULL,
  PRIMARY KEY (`id_accesorio`),
  KEY `id_lote` (`id_lote`),
  CONSTRAINT `accesorio_ibfk_1` FOREIGN KEY (`id_lote`) REFERENCES `lote_insumo` (`id_lote`)
...
INSERT INTO `accesorio` VALUES (1,'Pasadores de Neón',1),(2,'Broche Metálico',1);
