...
CREATE TABLE `lote_produccion` (
  ...
  `cantidad_zapatos` int DEFAULT NULL,
  `tiempo_estimado_horas` int DEFAULT NULL,
  `id_diseno` int DEFAULT NULL,
  PRIMARY KEY (`id_lote_produccion`),
  KEY `id_diseno` (`id_diseno`),
  CONSTRAINT `lote_produccion_ibfk_1` FOREIGN KEY (`id_diseno`) REFERENCES `diseno` (`id_diseno`)
...
INSERT INTO `lote_produccion` VALUES (300,3,12,3);
