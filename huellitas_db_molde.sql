...
CREATE TABLE `molde` (
  ...
  `forma` varchar(50) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `id_lote` int DEFAULT NULL,
  PRIMARY KEY (`id_molde`),
  KEY `id_lote` (`id_lote`),
  CONSTRAINT `molde_ibfk_1` FOREIGN KEY (`id_lote`) REFERENCES `lote_insumo` (`id_lote`)
...
INSERT INTO `molde` VALUES (1,'40','Deportiva',1);
